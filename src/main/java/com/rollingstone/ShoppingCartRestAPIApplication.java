...
@EnableSwagger2
public class ShoppingCartRestAPIApplication extends SpringBootServletInitializer {

    private static final Class<ShoppingCartRestAPIApplication> applicationClass = ShoppingCartRestAPIApplication.class;
